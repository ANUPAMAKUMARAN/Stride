...
const effectiveSlideGap = isMobile ? 10 : slideGap; // 10px gap on mobile
const effectivePadding = isMobile ? 10 : 40; // reduce outer padding too
...
const sliderStyle = {
  ...
  padding: `0 ${effectivePadding * scale}px`, // reduce side padding
