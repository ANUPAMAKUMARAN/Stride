  ...
  return (
    <div className="w-full py-6 bg-gradient-to-b from-white to-white">
      <div className="w-full max-w-[900px] mx-auto relative px-2 sm:px-4 lg:px-8">
        ...
        <div
          className="absolute top-0 left-0 h-full z-10 pointer-events-none w-[15%] sm:w-[12%] md:w-[10%] lg:w-[25%]"
          style={{
        ...
        <div
          className="absolute top-0 right-0 h-full z-10 pointer-events-none w-[15%] sm:w-[12%] md:w-[10%] lg:w-[25%]"
          style={{
