...
const Gradient = () => {
    ...
    return (
        // Apply the gradient to the outermost div
        <div className="w-full py-6 bg-gradient-to-b from-white to-white">
            <div className="max-w-screen-md mx-auto relative px-2 sm:px-4 lg:px-8">
                ...
                {/* Left Gradient Overlay - adjust background to match the main background */}
                <div
                    className="absolute top-0 left-0 h-full z-10 pointer-events-none"
                    style={{
                        width: "25%",
                        // Adjusting the gradient overlay to blend with the new background
                        background: "linear-gradient(to right, #FFFFFF 0%, rgba(255,255,255,0.6) 50%, rgba(255,255,255,0) 100%)"
                    }}
                />

                {/* Right Gradient Overlay - adjust background to match the main background */}
                <div
