        ...
        {slides.map((slide, index) => (
          <div
            ...
            style={{
              ...
              marginRight: index === slides.length - 1 ? "0" : `${20 * scaleMultiplier}px`,
      ...
      {showModal && selectedSlide && (
        ...
        >
          ...
          >
            ...
            {/* ✅ Show Pages (description + image) */}
            {selectedSlide.pages &&
              selectedSlide.pages.map((page, i) => (
...
//   // Calculate slideWidth and visibleSlides
//   useEffect(() => {
//     const handleResize = () => {
//       if (window.innerWidth < 768) {
//         setSlideWidth(window.innerWidth * 0.65);
...
//   const leftArrowSvg = (
//     <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="#333" viewBox="0 0 16 16">
...
//   return (
//     <div style={{ width: "100%", overflow: "hidden", padding: `${40 * scaleMultiplier}px 0`, paddingLeft: isDesktop ? `${100 * scaleMultiplier}px` : "0px" }}>
//       <h2 style={{ textAlign: "left", color: titleColor || "#000", fontSize: `${44 * scaleMultiplier}px`, fontWeight: 600, marginBottom: `${20 * scaleMultiplier}px`, paddingLeft: `${20 * scaleMultiplier}px` }}>
//         {title}
//       </h2>
...
//               />
//             )}
//             <div style={{ position: "absolute", top: `${20 * scaleMultiplier}px`, left: `${20 * scaleMultiplier}px`, right: `${20 * scaleMultiplier}px`, color: slide.titleColor || "#fff" }}>
//               <h4 style={{ color: slide.captionColor || "#fff", fontSize: `${19 * scaleMultiplier}px`, marginBottom: `${3 * scaleMultiplier}px` }}>{slide.caption}</h4>
//               <h3 style={{ color: slide.titleColor || "#fff", fontSize: `${30 * scaleMultiplier}px`, fontWeight: 500, lineHeight: "1.3" }}>{slide.title}</h3>
//             </div>
//             <button
//               style={{
//                 position: "absolute",
...
//       {/* Arrows */}
//       <div style={{ display: "flex", justifyContent: isDesktop ? "flex-end" : "center", marginTop: `${15 * scaleMultiplier}px`, gap: `${20 * scaleMultiplier}px`, paddingRight: isDesktop ? "20px" : "0" }}>
//         <button onClick={() => jumpSlide("prev")} style={{ width: "40px", height: "40px", borderRadius: "50%", border: "1px solid #ccc", background: "#fff", cursor: "pointer", display: "flex", justifyContent: "center", alignItems: "center" }}>{leftArrowSvg}</button>
//         <button onClick={() => jumpSlide("next")} style={{ width: "40px", height: "40px", borderRadius: "50%", border: "1px solid #ccc", background: "#fff", cursor: "pointer", display: "flex", justifyContent: "center", alignItems: "center" }}>{rightArrowSvg}</button>
//       </div>
...
//       <p
//         style={{
//           fontSize: `${18 * scaleMultiplier}px`,
//           color: "#444",
//           lineHeight: "1.6",
//           margin: 0,
//         }}
