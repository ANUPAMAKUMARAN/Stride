...
// import { FaGlobe, FaShieldAlt, FaLock, FaStar } from "react-icons/fa";
...
//     icon: <FaStar />,
//     title:
//       "Trusted by professionals, nurses & job seekers worldwide",
...
// const IconCard = ({ icon, title, description, scale }) => {
...
//       <p style={{ fontSize: 14 * scale, margin: 0 }}>{title}</p>

//       {/* Hover Box - directly under icon */}
//       {hover && (
//         <div
//           style={{
//             position: "absolute",
//             top: 60 * scale, // right below the icon
//             width: "100%",
//              background: "#fff", 
//             // background: "rgba(00, 64, 175, 0.95)",
//             // color: "#fff",
//             color: "#1e40af",  
//             fontSize: 12 * scale,
    ...
    >
      ...
      {hover && (
        <div
          style={{
            position: "absolute",
            top: 60 * scale, // below icon
            width: "100%",
            background: "#f5f5f5", // or "#fff8e1" for cream
            color: "#1e40af", // text color for visibility
            fontSize: 12 * scale,
            padding: `${6 * scale}px ${8 * scale}px`,
            borderRadius: 4 * scale,
            zIndex: 10,
