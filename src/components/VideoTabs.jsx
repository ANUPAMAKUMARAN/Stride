...
//         // 🔹 Ensure first video auto-plays on load
//         if (icons.length && isYouTube(icons[0]?.vdo)) {
//             setActiveIndex(0); // triggers the main useEffect to initialize player
//         }
//     };
//   }, []);
...
//             }
//         };
//     }, [activeIndex, isCurrentVideoYouTube, embedId, startProgressTracking, stopProgressTracking]); // Added new dependencies
