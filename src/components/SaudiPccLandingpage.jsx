...
const SaudiPccLandingpage = ({ attributes }) => {
    ...
    const [outerMargin, setOuterMargin] = useState(80); // ⬅️ NEW
                    ...
                    <>
                        <video
                            ...
                            style={{
                                ...
                                // width: "100%",
                                 left: isMobile ? 0 : outerMargin, // mobile: no margin
    width: isMobile ? "100%" : `calc(100% - ${outerMargin * 2}px)`,
...
//             const width = window.innerWidth;
//             const maxWidth = 1400;
//             const newScale = Math.min(1, width / maxWidth);
