...
const SaudiPccLandingpage = ({ attributes }) => {
    ...
    const iconRowMaxWidth = `${620 * scale}px`;
        ...
        >
            ...
            <div
                style={{
                    ...
                    position: "relative",
                    padding: isMobile ? `${20 * scale}px` : `${90 * scale}px`,
                    boxSizing: "border-box",
                    overflow: "hidden",
                }}
            >
                ...
                >
                    ...
                    >
                                ...
                                >
                                    <img
                                        ...
                                        style={{
                                            ...
                                            marginLeft: idx > 0 ? `-${12 * scale}px` : "0",
                                            cursor: "pointer",
                                        }}
                                    />
                                    {hoveredReview === idx && (
                        ...
                        >
                            ⭐⭐⭐⭐⭐ End-to-end service trusted by 500+ professionals worldwide
                        </div>
                    </div>
                </div>
            </div>
