...
export const SaudiPccLandingpageData = {
    backgroundColor: "#fff",

    caption: "Outside Saudi Arabia",
    captionColor: "#0077b6",

    title: "Get Your Saudi PCC Online- Fast & Easy",
    titleColor: "#0b0b0b",
    ...
    buttons: [
        ...
        { buttonText: "FAQ", buttonTextColor: "#000", buttonColor: "#f1f5f9" },
