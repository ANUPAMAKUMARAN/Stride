export const KlarnaBrandsData = {
    ...
    titleColor: "#333",
    // NOTE: I've added a 'columnSpan' for tiles that stretch across multiple columns (like the widest ones)
    // and standardized the 'height' to better control the column layout.
    slides: [
        // --- Column 1 Items ---
        {
